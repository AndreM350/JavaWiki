package JavaRoadMap.JavaUtilEStreams.StreamAPIMaisJava8.Topico1Alura;
...
public class ForEach {
    ...
    /* Os trechos abaixo podem ser substituidos por JavaRoadMap.Lambdas dentro das funções acima */
